...
import { UpdateBarang } from "../../lib/actions";

const EditBarangForm = ({ barang }) => {
  const updateBarangId = UpdateBarang.bind(null, barang.id_barang);
  const [state, formAction] = useFormState(updateBarangId, null);
  return (

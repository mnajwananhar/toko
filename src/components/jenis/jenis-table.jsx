...
import { DeleteButtonJenis, EditButtonJenis } from "../buttons";

const JenisTable = async ({ query, currentPage }) => {
        ...
        {barang.map((item, index) => (
          <tr key={index.id} className="bg-white border-b">
            ...
            <td className="px-6 py-4 text-center">
              <EditButtonJenis id={item.id_barang} />
              <DeleteButtonJenis id={item.id_barang} />
            </td>
          </tr>
        ))}
      </tbody>
